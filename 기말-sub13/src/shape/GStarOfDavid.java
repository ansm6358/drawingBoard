...
public class GStarOfDavid extends GShape {
	...
	public void setPoint(int x, int y) {
		...
		this.polygon.addPoint(this.px+(x-this.px)*4/5, this.py+(y-this.py)/2);
		
		this.polygon.addPoint(x, this.py+(y-this.py)*2/3);
		...
		this.polygon.addPoint(this.px, this.py+(y-this.py)*2/3);
		this.polygon.addPoint(this.px+(x-this.px)/5, this.py+(y-this.py)/2);
	}
	public void addPoint(int x, int y) {
	}
	
	public GShape newInstance() {
		return new GStarOfDavid();
	}
