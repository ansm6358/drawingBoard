...
import shape.GCircle;
import shape.GRegularPolygon;
import shape.GCloud;
import shape.GHeart;
import shape.GMoon;
import shape.GText;
...
public class Constants {
	...
	public enum EToolBar {
		...
		circle("원", new GCircle()),
		regularPolygon("정다각형", new GRegularPolygon()),
		cloud("구름", new GCloud()),
		heart("하트", new GHeart()),
		moon("달", new GMoon()),
		texts("글자", new GText()),
	...
	public enum ESpecial {
		...
		cloud("구름", "image//cloud.png"),
		heart("하트", "image//heart.png"),
		moon("달", "image//moon.png"),
		texts("글자", "image//texts.png"),
		;
		private String text;
		private String image;
	...
	public enum EPoly {
		...
		regularPolygon("정다각형", "image//regularPolygon.png"),
		;
		private String text;
		private String image;
	...
	public enum EEditMenu {
		...
		delete("삭제하기", "delete",'B', KeyEvent.CTRL_MASK),
