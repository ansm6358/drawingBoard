...
public abstract class GTransformer {
	...
	public abstract void keepTransforming(Graphics2D graphics2D, int x, int y, Color color);
	public abstract void finishTransforming(Graphics2D graphics2D, int x, int y);
	public abstract void continueTransforming(Graphics2D graphics2d, int x, int y, Color background);
}
